...
import { ParticipantInterpretationFlags } from "./ParticipantInterpretationFlags";
...
export class InterpretationRequestsRD extends JSONHelper {
   ...
   * Internal study identifier
   */
  @JsonProperty("familyInternalId", String, true)
  familyInternalId?: string = undefined;
   ...
   */
  @JsonProperty("pedigreeDiagram", File, true)
  pedigreeDiagram?: File = undefined;
   ...
   */
  @JsonProperty("participantsInterpretationFlags", [ParticipantInterpretationFlags])
  participantsInterpretationFlags?: ParticipantInterpretationFlags[] = undefined;
