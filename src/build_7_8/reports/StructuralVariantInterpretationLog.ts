...
@JsonObject
export class StructuralVariantInterpretationLog {

  /**
  Variant details
  */
  @JsonProperty("variant", StructuralVariantDetails)
  variant: StructuralVariantDetails = new StructuralVariantDetails();
