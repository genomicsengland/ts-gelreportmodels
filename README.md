...
let jsonData = {/* ... */};
build_v7_0.CVA.ReportEventEntry.fromJSON(jsonData);
```
...
```
typedoc --out ./doc src --name 'GelRportModels TypeScript'
```

Open `index.html` in the `./doc` folder

## To do

- [ ] Useful methods for both projects
- [ ] Tests
- [ ] Verify info we need for VariantAvro, Property models
- [ ] Add enum checks for enum fields as these are just strings at the moment
