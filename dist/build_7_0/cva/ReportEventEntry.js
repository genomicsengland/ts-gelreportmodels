...
var ReportEventEntry = /** @class */ (function (_super) {
    ...
    function ReportEventEntry() {
        ...
        _this.parentVersion = undefined; // int
        _this.groupId = '';
        _this.cohortId = '';
        _this.date = '';
        _this.author = '';
    ...
    __decorate([
        json2typescript_1.JsonProperty('parentId', String, true)
    ], ReportEventEntry.prototype, "parentId", void 0);
    __decorate([
        json2typescript_1.JsonProperty('parentVersion', Number, true)
    ], ReportEventEntry.prototype, "parentVersion", void 0);
    __decorate([
