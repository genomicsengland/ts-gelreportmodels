...
test("Parse CancerInterpretationRequest payload (null filled)", function () {
    InterpretationRequestsRD_1.InterpretationRequestsRD.fromJSON(payloads_1.rdInterpretationRequestFilledPayload);
});
test("Parse CancerInterpretationRequest payload (null)", function () {
    InterpretationRequestsRD_1.InterpretationRequestsRD.fromJSON(payloads_1.rdInterpretationRequestNullPayload);
});
