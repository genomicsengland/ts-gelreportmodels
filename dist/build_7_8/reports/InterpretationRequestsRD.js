...
var ParticipantInterpretationFlags_1 = require("./ParticipantInterpretationFlags");
var InterpretationRequestsRD = /** @class */ (function (_super) {
    ...
    function InterpretationRequestsRD() {
         ...
         * Internal study identifier
         */
        _this.familyInternalId = undefined;
        /**
         ...
         */
        _this.pedigreeDiagram = undefined;
        /**
         ...
         */
        _this.participantsInterpretationFlags = undefined;
        /**
    ...
    __decorate([
        json2typescript_1.JsonProperty("familyInternalId", String, true)
    ], InterpretationRequestsRD.prototype, "familyInternalId", void 0);
    __decorate([
    ...
    __decorate([
        json2typescript_1.JsonProperty("pedigreeDiagram", File_1.File, true)
    ], InterpretationRequestsRD.prototype, "pedigreeDiagram", void 0);
    __decorate([
    ...
    __decorate([
        json2typescript_1.JsonProperty("participantsInterpretationFlags", [ParticipantInterpretationFlags_1.ParticipantInterpretationFlags])
    ], InterpretationRequestsRD.prototype, "participantsInterpretationFlags", void 0);
    __decorate([
