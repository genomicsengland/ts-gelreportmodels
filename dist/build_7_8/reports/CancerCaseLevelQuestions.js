...
exports.CancerCaseLevelQuestions = void 0;
...
var CancerCaseLevelQuestions = /** @class */ (function () {
    ...
    ], CancerCaseLevelQuestions.prototype, "total_review_time", void 0);
    __decorate([
        json2typescript_1.JsonProperty("mdt1_time", Number)
    ], CancerCaseLevelQuestions.prototype, "mdt1_time", void 0);
    __decorate([
        json2typescript_1.JsonProperty("mdt2_time", Number, true)
    ], CancerCaseLevelQuestions.prototype, "mdt2_time", void 0);
    __decorate([
        json2typescript_1.JsonProperty("validation_assay_time", Number, true)
    ], CancerCaseLevelQuestions.prototype, "validation_assay_time", void 0);
    __decorate([
        json2typescript_1.JsonProperty("wet_validation_time", Number, true)
    ], CancerCaseLevelQuestions.prototype, "wet_validation_time", void 0);
    __decorate([
        json2typescript_1.JsonProperty("analytical_validation_time", Number, true)
    ], CancerCaseLevelQuestions.prototype, "analytical_validation_time", void 0);
    __decorate([
        json2typescript_1.JsonProperty("primary_reporting_time", Number)
    ], CancerCaseLevelQuestions.prototype, "primary_reporting_time", void 0);
    __decorate([
        json2typescript_1.JsonProperty("primary_authorisation_time", Number)
    ], CancerCaseLevelQuestions.prototype, "primary_authorisation_time", void 0);
    __decorate([
        json2typescript_1.JsonProperty("report_distribution_time", Number)
    ], CancerCaseLevelQuestions.prototype, "report_distribution_time", void 0);
    __decorate([
        json2typescript_1.JsonProperty("total_time", Number)
    ], CancerCaseLevelQuestions.prototype, "total_time", void 0);
    __decorate([
        json2typescript_1.JsonProperty("reviewedInMdtWga", String)
    ], CancerCaseLevelQuestions.prototype, "reviewedInMdtWga", void 0);
    __decorate([
        json2typescript_1.JsonProperty("actionableVariants", String)
    ], CancerCaseLevelQuestions.prototype, "actionableVariants", void 0);
