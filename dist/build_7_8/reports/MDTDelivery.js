...
var InterpretationDataRd = /** @class */ (function () {
    ...
    __decorate([
        json2typescript_1.JsonProperty("interpretationMetaData", InterpretationRequestsRD_1.InterpretationRequestsRD)
    ], InterpretationDataRd.prototype, "interpretationMetaData", void 0);
    __decorate([
        json2typescript_1.JsonProperty("tieringResult", InterpretedGenome_1.InterpretedGenome, true)
    ], InterpretationDataRd.prototype, "tieringResult", void 0);
    __decorate([
        json2typescript_1.JsonProperty("otherInterpretationResults", [InterpretedGenome_1.InterpretedGenome], true)
    ], InterpretationDataRd.prototype, "otherInterpretationResults", void 0);
...
var InterpretationDataCancer = /** @class */ (function () {
    ...
    __decorate([
        json2typescript_1.JsonProperty("interpretationMetaData", CancerInterpretationRequest_1.CancerInterpretationRequest)
    ], InterpretationDataCancer.prototype, "interpretationMetaData", void 0);
    __decorate([
        json2typescript_1.JsonProperty("tieringResult", InterpretedGenome_1.InterpretedGenome, true)
    ], InterpretationDataCancer.prototype, "tieringResult", void 0);
    __decorate([
        json2typescript_1.JsonProperty("otherInterpretationResults", [InterpretedGenome_1.InterpretedGenome], true)
    ], InterpretationDataCancer.prototype, "otherInterpretationResults", void 0);
