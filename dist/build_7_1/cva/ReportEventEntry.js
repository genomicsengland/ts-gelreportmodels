...
var ReportEventEntry = /** @class */ (function(_super) {
  ...
  __decorate(
    [
      json2typescript_1.JsonProperty(
        ...
        ReportEventQuestionnaireRD_1.ReportEventQuestionnaireRD
      )
    ],
    ReportEventEntry.prototype,
    "reportEventQuestionnaire",
  ...
  __decorate(
    [
      json2typescript_1.JsonProperty(
        ...
        ReportEventQuestionnaireCancer_1.ReportEventQuestionnaireCancer
      )
    ],
    ReportEventEntry.prototype,
    "reportEventQuestionnaireCancer",
  ...
  __decorate(
    [
      json2typescript_1.JsonProperty("observedVariants", [
        ObservedVariant_1.ObservedVariant
      ])
    ],
    ReportEventEntry.prototype,
    "observedVariants",
  ...
  __decorate(
    [
      json2typescript_1.JsonProperty("additionalProperties", [
        biodata_1.Property
      ])
    ],
    ReportEventEntry.prototype,
