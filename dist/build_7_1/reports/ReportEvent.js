...
var ReportEvent = /** @class */ (function(_super) {
  ...
  __decorate(
    [
      json2typescript_1.JsonProperty("variantConsequences", [
        VariantConsequence_1.VariantConsequence
      ])
    ],
    ReportEvent.prototype,
    "variantConsequences",
  ...
  __decorate(
    [
      json2typescript_1.JsonProperty("genomicEntities", [
        GenomicEntity_1.GenomicEntity
      ])
    ],
    ReportEvent.prototype,
    "genomicEntities",
  ...
  __decorate(
    [
      json2typescript_1.JsonProperty(
        ...
        VariantClassification_1.VariantClassification,
        true
      )
    ],
    ReportEvent.prototype,
  ...
  ReportEvent = __decorate([json2typescript_1.JsonObject], ReportEvent);
  return ReportEvent;
