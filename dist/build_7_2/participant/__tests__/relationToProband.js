...
test("relation to proband: test maternal aunt", function () {
    ...
    expect(pedigree.members[1].pedigreeId).toEqual(pedigree_1.defaultValues.defaultMotherValues.pedigreeId);
    expect(pedigree.members[1].relationToProband).toBe(FamiliarRelationship_1.FamiliarRelationship.Mother);
    expect(pedigree.members[2].pedigreeId).toEqual(pedigree_1.defaultValues.defaultMaternalGrandMotherValues.pedigreeId);
    expect(pedigree.members[2].relationToProband).toBe(FamiliarRelationship_1.FamiliarRelationship.MaternalGrandmother);
...
test("relation to proband: test sibling", function () {
    ...
    var father = tests_1.getPedigree(pedigree_1.defaultValues.defaultFatherValues);
    var mother = tests_1.getPedigree(pedigree_1.defaultValues.defaultMotherValues);
    var sibling = tests_1.getPedigree(pedigree_1.defaultValues.defaultSiblingValues);
    ...
    expect(pedigree.members[1].pedigreeId).toEqual(pedigree_1.defaultValues.defaultFatherValues.pedigreeId);
    expect(pedigree.members[1].relationToProband).toBe(FamiliarRelationship_1.FamiliarRelationship.Father);
    expect(pedigree.members[2].pedigreeId).toEqual(pedigree_1.defaultValues.defaultMotherValues.pedigreeId);
    expect(pedigree.members[2].relationToProband).toBe(FamiliarRelationship_1.FamiliarRelationship.Mother);
...
test("relation to proband: test sibling", function () {
    ...
    var father = tests_1.getPedigree(pedigree_1.defaultValues.defaultFatherValues);
    var mother = tests_1.getPedigree(pedigree_1.defaultValues.defaultMotherValues);
    var siblingM = tests_1.getPedigree(pedigree_1.defaultValues.defaultSiblingMValues);
    ...
    expect(pedigree.members[2].pedigreeId).toEqual(pedigree_1.defaultValues.defaultMotherValues.pedigreeId);
    expect(pedigree.members[2].relationToProband).toBe(FamiliarRelationship_1.FamiliarRelationship.Mother);
    expect(pedigree.members[3].pedigreeId).toEqual(pedigree_1.defaultValues.defaultSiblingMValues.pedigreeId);
    expect(pedigree.members[3].relationToProband).toBe(FamiliarRelationship_1.FamiliarRelationship.FullSiblingM);
});
