...
var Pedigree = /** @class */ (function (_super) {
    ...
    function Pedigree() {
        ...
        _this.isSpouse = function (m1, m2) {
            ...
            _this.members.filter(function (o) {
                if ((o.fatherId && o.fatherId === m1.pedigreeId) ||
                    (o.motherId && o.motherId === m1.pedigreeId)) {
                    m1Offsprings.add(o);
                }
                if ((o.fatherId && o.fatherId === m2.pedigreeId) ||
    ...
    Pedigree.prototype.calculateRelationToProband = function () {
        ...
        var pairs = js_combinatorics_1.combination(this.members, 2).filter(function (pair) {
