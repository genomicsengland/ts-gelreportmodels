...
var PedigreeMember = /** @class */ (function () {
    ...
    ], PedigreeMember.prototype, "pedigreeId", void 0);
    __decorate([
        json2typescript_1.JsonProperty('isProband', Boolean, true)
    ], PedigreeMember.prototype, "isProband", void 0);
    __decorate([
        json2typescript_1.JsonProperty('participantId', String, true)
    ], PedigreeMember.prototype, "participantId", void 0);
    __decorate([
        json2typescript_1.JsonProperty('participantQCState', String, true)
    ], PedigreeMember.prototype, "participantQCState", void 0);
    __decorate([
        json2typescript_1.JsonProperty('gelSuperFamilyId', String, true)
    ], PedigreeMember.prototype, "gelSuperFamilyId", void 0);
    __decorate([
        json2typescript_1.JsonProperty('sex', String)
    ], PedigreeMember.prototype, "sex", void 0);
    __decorate([
        json2typescript_1.JsonProperty('personKaryotypicSex', String, true)
    ], PedigreeMember.prototype, "personKaryotypicSex", void 0);
    __decorate([
        json2typescript_1.JsonProperty('yearOfBirth', Number, true)
    ], PedigreeMember.prototype, "yearOfBirth", void 0);
    __decorate([
        json2typescript_1.JsonProperty('fatherId', Number, true)
    ], PedigreeMember.prototype, "fatherId", void 0);
    __decorate([
        json2typescript_1.JsonProperty('motherId', Number, true)
    ], PedigreeMember.prototype, "motherId", void 0);
    __decorate([
        json2typescript_1.JsonProperty('superFatherId', Number, true)
    ], PedigreeMember.prototype, "superFatherId", void 0);
    __decorate([
        json2typescript_1.JsonProperty('superMotherId', Number, true)
    ], PedigreeMember.prototype, "superMotherId", void 0);
    __decorate([
        json2typescript_1.JsonProperty('twinGroup', Number, true)
    ], PedigreeMember.prototype, "twinGroup", void 0);
    __decorate([
        json2typescript_1.JsonProperty('monozygotic', String, true)
    ], PedigreeMember.prototype, "monozygotic", void 0);
    __decorate([
        json2typescript_1.JsonProperty('adoptedStatus', String, true)
    ], PedigreeMember.prototype, "adoptedStatus", void 0);
    __decorate([
        json2typescript_1.JsonProperty('lifeStatus', String, true)
    ], PedigreeMember.prototype, "lifeStatus", void 0);
    __decorate([
        json2typescript_1.JsonProperty('consanguineousParents', String, true)
    ], PedigreeMember.prototype, "consanguineousParents", void 0);
    __decorate([
        json2typescript_1.JsonProperty('affectionStatus', String, true)
    ], PedigreeMember.prototype, "affectionStatus", void 0);
    __decorate([
        json2typescript_1.JsonProperty('disorderList', [Disorder_1.Disorder], true)
    ], PedigreeMember.prototype, "disorderList", void 0);
    __decorate([
        json2typescript_1.JsonProperty('hpoTermList', [HpoTerm_1.HpoTerm], true)
    ], PedigreeMember.prototype, "hpoTermList", void 0);
    __decorate([
        json2typescript_1.JsonProperty('ancestries', Ancestries_1.Ancestries, true)
    ], PedigreeMember.prototype, "ancestries", void 0);
    __decorate([
        json2typescript_1.JsonProperty('consentStatus', ConsentStatus_1.ConsentStatus, true)
    ], PedigreeMember.prototype, "consentStatus", void 0);
    __decorate([
        json2typescript_1.JsonProperty('samples', [Sample_1.Sample], true)
    ], PedigreeMember.prototype, "samples", void 0);
    __decorate([
        json2typescript_1.JsonProperty('inbreedingCoefficient', InbreedingCoefficient_1.InbreedingCoefficient, true)
    ], PedigreeMember.prototype, "inbreedingCoefficient", void 0);
    __decorate([
        json2typescript_1.JsonProperty('additionalInformation', Object, true)
    ], PedigreeMember.prototype, "additionalInformation", void 0);
    PedigreeMember = __decorate([
