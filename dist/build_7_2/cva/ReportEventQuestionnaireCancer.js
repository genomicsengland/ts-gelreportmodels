  ...
  __decorate(
    [
      json2typescript_1.JsonProperty(
        ...
        reports_1.CancerSomaticVariantLevelQuestions
      )
    ],
    ReportEventQuestionnaireCancer.prototype,
    "cancerSomaticVariantLevelQuestions",
    void 0
  );
  __decorate(
    [
      json2typescript_1.JsonProperty(
        ...
        reports_1.CancerGermlineVariantLevelQuestions
      )
    ],
    ReportEventQuestionnaireCancer.prototype,
    "cancerGermlineVariantLevelQuestions",
  ...
  __decorate(
    [
      json2typescript_1.JsonProperty(
        ...
        reports_1.CancerCaseLevelQuestions
      )
    ],
    ReportEventQuestionnaireCancer.prototype,
    "cancercaseLevelQuestions",
