...
var InterpretationRequestsRD = /** @class */ (function(_super) {
  ...
  __decorate(
    [
      json2typescript_1.JsonProperty(
        "versionControl",
        ReportVersionControl_1.ReportVersionControl
      )
    ],
    InterpretationRequestsRD.prototype,
    "versionControl",
    void 0
  );
  __decorate(
  ...
  __decorate(
    [
      json2typescript_1.JsonProperty(
        "otherFamilyHistory",
        OtherFamilyHistory_1.OtherFamilyHistory,
        true
      )
    ],
    InterpretationRequestsRD.prototype,
  ...
  __decorate(
    [
      json2typescript_1.JsonProperty("interpretationFlags", [
        InterpretationFlag_1.InterpretationFlag
      ])
    ],
    InterpretationRequestsRD.prototype,
    "interpretationFlags",
