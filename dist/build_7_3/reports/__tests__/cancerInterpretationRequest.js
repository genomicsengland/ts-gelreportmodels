...
test("Parse CancerInterpretationRequest payload (null filled)", function() {
  CancerInterpretationRequest_1.CancerInterpretationRequest.fromJSON(
    payloads_1.cancerInterpretationRequestFilledPayload
  );
});
test("Parse CancerInterpretationRequest payload (null)", function() {
  CancerInterpretationRequest_1.CancerInterpretationRequest.fromJSON(
    payloads_1.cancerInterpretationRequestNullPayload
  );
});
