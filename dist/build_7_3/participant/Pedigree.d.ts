...
export declare class Pedigree extends JSONHelper {
  ...
  isParent: (
    m1: PedigreeMember,
    m2: PedigreeMember
  ) => FamiliarRelationship.Mother | FamiliarRelationship.Father | undefined;
  /**
  ...
  isChild: (
    ...
    | FamiliarRelationship.Son
    | FamiliarRelationship.Daughter
    | FamiliarRelationship.ChildOfUnknownSex
    | undefined;
  /**
  ...
  isSibling: (
    ...
    | FamiliarRelationship.TwinsMonozygous
    | FamiliarRelationship.TwinsDizygous
    | FamiliarRelationship.TwinsUnknown
    | FamiliarRelationship.FullSibling
    | FamiliarRelationship.FullSiblingF
  ...
  isUncleOrAunt: (
    ...
    | FamiliarRelationship.MaternalUncle
    | FamiliarRelationship.MaternalUncleOrAunt
    | FamiliarRelationship.PaternalAunt
    | FamiliarRelationship.PaternalUncle
    | FamiliarRelationship.PaternalUncleOrAunt
    | undefined;
  isFirstCousing: (
    m1: PedigreeMember,
    m2: PedigreeMember
  ) =>
    | FamiliarRelationship.DoubleFirstCousin
    | FamiliarRelationship.MaternalCousinSister
    | FamiliarRelationship.PaternalCousinSister
    | FamiliarRelationship.MaternalCousinBrother
    | FamiliarRelationship.PaternalCousinBrother
    | FamiliarRelationship.Cousin
    | undefined;
  /**
  ...
  isGrandParent: (
    ...
    | FamiliarRelationship.PaternalGrandmother
    | FamiliarRelationship.MaternalGrandfather
  ...
  isSpouse: (
    m1: PedigreeMember,
    m2: PedigreeMember
  ) => FamiliarRelationship.Spouse | undefined;
  /**
  ...
  isUnrelated: (
    m1: PedigreeMember,
    m2: PedigreeMember
  ) => FamiliarRelationship.Unrelated | undefined;
  /**
