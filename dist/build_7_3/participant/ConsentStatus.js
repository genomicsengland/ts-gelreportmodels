...
var ConsentStatus = /** @class */ (function () {
    ...
    ], ConsentStatus.prototype, "programmeConsent", void 0);
    __decorate([
        json2typescript_1.JsonProperty('primaryFindingConsent', Boolean)
    ], ConsentStatus.prototype, "primaryFindingConsent", void 0);
    __decorate([
        json2typescript_1.JsonProperty('secondaryFindingConsent', Boolean)
    ], ConsentStatus.prototype, "secondaryFindingConsent", void 0);
    __decorate([
        json2typescript_1.JsonProperty('carrierStatusConsent', Boolean)
    ], ConsentStatus.prototype, "carrierStatusConsent", void 0);
    ConsentStatus = __decorate([
